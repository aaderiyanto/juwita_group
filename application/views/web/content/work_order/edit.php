...
if(!empty($arr->id_manufacture) && in_array($arr->flag_data,array("2","3"))){
                            ...
                            <!--<div class="info_error"></div>-->
								<fieldset class="content-group">
                                    ...
                                    <div class="form-group">
										...
										<div class="col-lg-10">
											<textarea name="keterangan" id="keterangan" class="form-control" rows="3" placeholder="masukkan isian data" required="required"><?= $arr->keterangan; ?></textarea>
										</div>
									</div>
