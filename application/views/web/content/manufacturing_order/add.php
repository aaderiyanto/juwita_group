                            ...
                            <!--<div class="info_error"></div>-->
								<fieldset class="content-group">
                                    ...
                                    <div class="form-group">
										...
										<div class="col-lg-10">
										<input type="text" name="nama_produk" id="nama_produk" class="form-control" placeholder="text input..." required="required"/>
                                        </div>                                       
									</div>
                                    <div class="form-group">
										<label class="control-label col-lg-2">Jumlah <span class="text-danger">*</span></label>
										<div class="col-lg-10">
										<input type="number" name="jumlah_produk" class="form-control" placeholder="number input..." required="required"/>
                                        </div>                                       
									</div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
										...
										<div class="col-lg-10">
										<input type="text" name="tgl_selesai" id="date_balqon2" class="form-control" placeholder="text input..." required="required" value="<?= $config['tgl']; ?>"/>
                                        </div>                                       
									</div>
                                    <div class="form-group">
