...
?>
							...
							<div class="modal-footer">
                                <?php if($arr->flag_po==1){ ?>
                                <a href="<?php echo $this->base_url($config["folder_apps"]).'ajax/purchase_order/cetak/'.$arr->id_po; ?>" class="btn btn-primary" target="_blank"><i class="icon-printer position-left"></i> Cetak</a>
                                <?php } ?>
