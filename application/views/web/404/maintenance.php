...
<head> 
	...
	<link href="<?php echo $this->base_url($config["folder_apps"]); ?>assets/css/maintenance.css" rel="stylesheet"/>
	<link href='<?php echo $config["font_google"]; ?>css?family=Anton' rel='stylesheet' type='text/css'>
	<script>
...
<body>
	<div id="level">
		<div id="content">
			...
			<div id="title">
				<h1>Portal dalam proses Maintenance.</h1>
				<p>Silahkan kunjungi portal kami beberapa saat lagi. Terimakasih.</p>
			</div>
		</div>
	</div>
</body>
