                ...
                <form action="#" id="form" class="form-horizontal" autocomplete="off">
                    ...
                    <input type="hidden" value="" name="id"/>
                        <div class="form-group">
                            <label class="control-label col-md-3">Nama Asset <span class="text-danger">*</span></label>
                            <div class="col-md-9">
                                <input name="nama_asset" id="nama_asset" placeholder="Text input..." class="form-control" type="text" required>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <textarea name="keterangan" placeholder="Text input..." class="form-control" rows="3" required></textarea>
                                <span class="help-block"></span>
                            </div>
                        </div>
                </form>
