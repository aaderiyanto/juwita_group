...
<tr>
    ...
    <th width="10%">QTY</th>
    <th width="16%" style="display:none;">NOMINAL</th>
    <th width="18%" style="display:none;">SUB TOTAL</th>
</tr>
<?php
...
<tr>
	...
	<td align="right" style="display:none;"><span style="float:left;">Rp. </span> <?php echo $this->rupiah($raw->nominal); ?></td>
	<td align="right" style="display:none;"><span style="float:left;">Rp. </span> <?php echo $this->rupiah($total); ?></td>
</tr>
<?php 
endforeach; 
