...
<div class="panel-body">
                            <form class="form-horizontal form-validate-jquery" action="<?= $this->base_url($config['folder_apps']); ?>ajax/finance_transaksi/rek_koran" method="post" autocomplete="off" enctype="multipart/form-data" target="_blank">
                            <div class="info_error"></div>
								<fieldset class="content-group">
                                    <div class="form-group">
										<label class="control-label col-lg-3">Akun <span class="text-danger">*</span></label>
										<div class="col-lg-9">
                                        <select name="id_akun" data-placeholder="Pilih :" class="select-size-lg" id="id_akun" required>
