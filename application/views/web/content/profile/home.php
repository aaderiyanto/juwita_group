...
?>
	...
	<?php if(in_array($this->baca_session("level"),array("admin"))){ ?>
	<a href="#" class="btn btn-info" onclick="window.location='<?php echo $this->base_url($config["folder_apps"]); ?><?= $url_system[1]; ?>/add'"><i class="icon-plus2 text-white-400"></i></a>
    <?php } ?>
