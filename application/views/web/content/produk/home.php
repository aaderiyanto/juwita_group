...
<link rel="stylesheet" href="<?php echo $this->base_url($config["folder_apps"]); ?>assets/css_crop/slim.min.css">
    ...
    <a href="#" class="btn btn-success" onclick="window.location='<?php echo $this->base_url($config["folder_apps"]); ?><?= $folder_grid; ?>/print_qr'"><i class="icon-printer text-white-400"></i></a>
                                ...
                                <table id="table_bmt" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>Nama Produk</th>
                                            <th width="13%">Stok Kantin</th>
                                            <th width="14%">Stok Gudang</th>
