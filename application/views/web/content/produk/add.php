                            ...
                            <div class="info_error"></div>
								<fieldset class="content-group">
                                    <div class="form-group">
										...
										<div class="col-lg-10">
										<input type="text" name="nama_produk" id="nama_produk" class="form-control" placeholder="text input..." required="required" autofocus="autofocus"/>
                                        </div>                                       
									</div>
<!-- START -->
<div class="row">
<div class="col-lg-8">
                                    ...
                                    <div class="form-group">
										...
										foreach($arr_list as $val_data){
											if($val_data=='stok'){$pilih='selected';} else {$pilih='';}
										?>
                                    ...
                                    <div class="form-group">
										...
										<div class="col-lg-9">
										<input type="text" name="sku" id="sku" class="form-control" placeholder="text input..." required="required"/>
                                        </div>                                       
									</div>
<?php
...
?>
                                    <div class="form-group">
										...
										<div class="col-lg-9">
										<input type="text" name="harga_modal" id="non_idr2" class="form-control" placeholder="text input..." required="required" onkeyup="LoadIDRupiah(2)"/>
                                        </div>                                       
									</div>
<?php } ?>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
										...
										<div class="col-lg-9">
											<textarea name="deskripsi" id="deskripsi" class="form-control" rows="4" placeholder="masukkan isian data"></textarea>
										</div>
									</div>
</div>
<div class="col-lg-4">
...
<!-- END -->
                                    ...
                                    <div class="form-group">
										...
										<div class="col-lg-10">
											<textarea name="spesifikasi" id="spesifikasi" class="form-control" rows="4" placeholder="masukkan isian data"></textarea>
										</div>
									</div>
								</fieldset>
