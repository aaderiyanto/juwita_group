...
if($this->cek_login()== TRUE){
		...
		$column_order = array(null,"a.tgl_transaksi","a.no_transaksi","b.nama_akun","c.kategori","a.nominal","a.keterangan","a.flag_aktif");
		$column_search = array("a.tgl_transaksi","a.no_transaksi","b.nama_akun","c.kategori","a.nominal","IF(a.flag_aktif=1,'Ya Aktif','Tidak Aktif')");
		$order_by = array('a.tgl_input' => 'DESC'); // default order
		$where_default = array("a.jenis_data='d'"); 
		$field_tbl = "a.*, b.nama_akun, c.kategori";
		$join_table = array("finance_akun b" => "b.id_akun=a.id_akun",
							"finance_kategori c" => "c.id_katfinance=a.id_katfinance");
