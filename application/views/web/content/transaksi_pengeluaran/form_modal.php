...
<div class="panel-body">
                            <form class="form-horizontal form-validate-jquery" action="<?= $this->base_url($config['folder_apps']); ?>ajax/transaksi_pengeluaran/rek_koran" method="post" autocomplete="off" enctype="multipart/form-data" target="_blank">
