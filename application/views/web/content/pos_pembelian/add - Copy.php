		...
		foreach($arr_barang as $id_produk){
			...
			if($save==TRUE){
				...
				if($arr_produk->jenis_data=='stok'){
					$this->data_update("pos_produk","stok=stok+".$jumlah,"id_produk='".$id_produk."'");
				}
			}
			$no++;
		}
                            ...
                            <!--<div class="info_error"></div>-->
								<fieldset class="content-group">
                                    <div class="form-group">
										<label class="control-label col-lg-2">Nomor Invoice <span class="text-danger">*</span></label>
										<div class="col-lg-10">
										<input type="text" name="no_invoice" id="no_invoice" class="form-control" placeholder="text input..." required="required" autofocus="autofocus"/>
                                        </div>                                       
									</div>
                                    <div class="form-group">
										<label class="control-label col-lg-2">Tanggal Invoice <span class="text-danger">*</span></label>
										<div class="col-lg-10">
										<input type="text" name="tgl_invoice" id="date_balqon1" class="form-control" placeholder="text input..." required="required" value="<?= $config['tgl']; ?>"/>
                                        </div>                                       
									</div>
                                    <div class="form-group">
										...
										?>
                                        	<option value="<?php echo $raw->id_vendor; ?>"><?php echo $raw->nama; ?></option>
                                        <?php
										endforeach;
										?>                                        
										</select>
