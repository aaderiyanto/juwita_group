            ...
            <div style="padding:5px;"></div>
				...
				<tbody>
					<tr id='addr0'>
                        ...
                        <td>
						<input type="text" name="jumlah[]" class="form-control qty1" id="jumlah_awal" value="0" required placeholder="masukkan isian data" required onblur='subtotal(1),findTotal(1)' disabled="disabled">
						</select>

						</td>
						<td style="display:none;">
						<input type="text" name="nominal[]" class="form-control nominal_awal nominal1" value="0" required placeholder="masukkan isian data" id="non_idr1" onkeyup="LoadIDRupiah(1)" onblur="subtotal(1),findTotal(1)" disabled="disabled">
						</td>
                        <td style="display:none;">
                        <!-- SUB TOTAL -->
