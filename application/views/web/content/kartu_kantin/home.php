    ...
    <a href="#" class="btn btn-warning" onClick="reload_table()"><i class="icon-loop3 text-white-400"></i></a>
                                ...
                                <table id="table_bmt" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                    <thead>
                                        <tr>
                                            <th width="5%">No</th>
                                            <th width="16%">Qr Code</th>
                                            <th width="14%">Kode QR</th>
                                            <th>Keterangan</th>
                                            <th width="14%">Status Print</th>
                ...
                <form action="#" id="form" class="form-horizontal" autocomplete="off">
                    ...
                    <input type="hidden" value="" name="id"/>
                        <div class="form-group">
                            <label class="control-label col-md-3">Jumlah Generate <span class="text-danger">*</span></label>
                            <div class="col-md-9">
                                <input name="jumlah_cetak" id="jumlah_cetak" value="1" placeholder="Text input..." class="form-control" type="number" required>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <textarea name="keterangan" id="keterangan" rows="3" placeholder="Text input..." class="form-control" required></textarea>
                                <span class="help-block"></span>
                            </div>
                        </div>
                        <!--<div class="form-group">
