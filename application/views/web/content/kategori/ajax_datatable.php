...
if($this->cek_login()== TRUE){
		...
		foreach ($list as $person) {
			...
			$row[] = $aktif;
			//add html for action
			$row[] = '<a class="" href="javascript:void(0)" title="Edit" onclick="edit_person('."'".$person->id_kategori."'".')"><i class="glyphicon glyphicon-pencil"></i></a> &nbsp; 
				  <a class="" href="javascript:void(0)" title="Hapus" onclick="delete_person('."'".$person->id_kategori."'".')"><i class="glyphicon glyphicon-trash"></i></a>';
			$data[] = $row;
		}
