 ...
 */
$not_access = array("cashier","kepala_kantin","funding_officer","gudang");
                            ...
                            <!--<div class="info_error"></div>-->
								<fieldset class="content-group">
                                    ...
                                    <div class="form-group">
										...
										<div class="col-lg-10">
											<textarea name="ship_to" id="ship_to" class="form-control" rows="2" placeholder="masukkan isian data" required="required"><?= $arr->ship_to; ?></textarea>
										</div>
									</div>
                                    <div class="form-group">
										<label class="control-label col-lg-2">Status PO <span class="text-danger">*</span></label>
										<div class="col-lg-10">
                                        <select name="flag_po" data-placeholder="Pilih :" class="select-size-lg required" id="flag_po">
                                            <option value="">Pilih :</option>
                                        <?php
										$array_flagpo = array("2"=>"Pending","1"=>"Sdh Disetujui","0"=>"Batal");
										foreach($array_flagpo as $id_val=>$val_data){
											if($id_val==$arr->flag_po){$pilih='selected';} else {$pilih='';}
										?>
                                        	<option value="<?php echo $id_val; ?>" <?= $pilih; ?>><?php echo $val_data; ?></option>
                                        <?php
										}
...
?>
					<tr id='addr<?= $no; ?>'>
                        ...
                        <input type='hidden' name='stok_info[]' value="<?= $arr_produk->stok_gudang; ?>" id="stok_info<?= $no; ?>"/>
						</td>
                        <td>
