...
<tr>
    ...
    <th width="15%">PEMASUKAN (D)</th>
    <th>DESKRIPSI</th>
</tr>
<?php
$sql = $this->db_array("finance_transaksi a",$field="a.*",$where="1 AND a.tgl_transaksi BETWEEN '".$from."' AND '".$to."' AND a.flag_aktif='1' AND a.jenis_data='d' $where_akun $where_kat ORDER BY a.tgl_transaksi,a.no_transaksi");
$no=0;
$subdebit=0;
$subkredit=0;
$subsaldo=0;
